# Loan-Fraud-Detection-Data Science Code Challenge
This project uses machine learning to predict whether a loan applicant will repay their loan. The project uses a dataset of historical loan data for a bank. 
### Project Domain : Banking/Loan
## Problem Statement :
`Business Requirement` - Banks/NBFC (Non-Banking Financial Company) which facilitates loans to their customers who dont default or avoid fraud.
As a banker, you would want to invest in customers who showed a profile of having a high probability of paying you back.

`Key issues` - Ensure NPAs are lower – meaning bank wants to be very diligent in giving loans to borrower
## Solution Approach :
...
1. The dataset of historical loan data from bank/NBFC is a valuable resource for loan repayment prediction.
...
### Dataset Decription : 
  * credit.policy: 1 if the customer meets the credit underwriting criteria of bank, and 0 otherwise
  *	purpose: The purpose of the loan (takes values "credit_card", "debt_consolidation", "educational", "major_purchase", "small_business", and "all_other")
  *	int.rate: The interest rate of the loan, as a proportion (a rate of 11% would be stored as 0.11). Borrowers judged by bank to be more risky are assigned higher interest rates
...
## Insights : 
The developed model can be used to improve the efficiency of loan lending by helping bank to make more informed decisions about whether to approve or deny loan applications. Here the model used is Extreme Gradient Boosting(XG Boost) model with the 94% degree of accuracy.
